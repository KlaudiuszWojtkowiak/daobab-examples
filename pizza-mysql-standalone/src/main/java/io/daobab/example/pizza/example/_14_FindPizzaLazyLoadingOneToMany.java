...
@Singleton
public class _14_FindPizzaLazyLoadingOneToMany implements DaobabExample{
	...
	public void test() {
		Pizza pizza=Select.entity(daoPizza)
				...
				.completeEntity( p->p.setSupplierLazyIngredients( ()->Select.entityList(daoIngredient)
		...
		pizza.getLazyIngredients().forEach(i->Printer.printIngredient(i));
	}
	

	public static void main(String[] args) {
		Executor.runTest(_14_FindPizzaLazyLoadingOneToMany.class);
	}
