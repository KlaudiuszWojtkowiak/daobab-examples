...
public interface ManagerStaffId<E extends EntityMap> extends ColumnRelationMap<E> {
    ...
    default Column<E,Integer,ManagerStaffId> colManagerStaffId(){
        return new Column<E,Integer,ManagerStaffId>() {
            ...
            @Override
            public Integer getColumnValue(ManagerStaffId entity){
            ...
            @Override
            public void setColumnValue(ManagerStaffId entity, Integer param){
