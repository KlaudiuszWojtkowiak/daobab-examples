...
public interface Title<E extends EntityMap> extends ColumnRelationMap<E> {
    ...
    default Column<E,String,Title> colTitle(){
        return new Column<E,String,Title>() {
            ...
            @Override
            public String getColumnValue(Title entity){
                if (entity==null) throw new AttemptToReadFromNullEntityException(getEntityClass(),"Title");
                return  entity.getTitle();
            }

            @Override
            public void setColumnValue(Title entity, String param){
