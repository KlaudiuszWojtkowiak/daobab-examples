...
public interface Notes<E extends EntityMap> extends ColumnRelationMap<E> {
    ...
    default Column<E,String,Notes> colNotes(){
        return new Column<E,String,Notes>() {
            ...
            @Override
            public String getColumnValue(Notes entity){
                if (entity==null) throw new AttemptToReadFromNullEntityException(getEntityClass(),"Notes");
                return  entity.getNotes();
            }

            @Override
            public void setColumnValue(Notes entity, String param){
